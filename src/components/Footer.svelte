...
>
  ...
  <div class="flex flex-col gap-4 items-center justify-center">
    ...
    <p><b class="pr-2">Email</b> aakashpr975@gmail.com</p>
    <p>
      <b class="pr-2">GitHub</b>
      <a href="www.github.com/aakash414" target="_blank" class="text-violet-400"
        >aakash414<sup class=""
    ...
    <p>
      ...
      <a
        href="https://www.linkedin.com/in/aakash-p-r-398290231/"
        target="_blank"
        class="text-violet-400"
        >Aakash P R<sup class=""
          ><span class="text-xs scale-75 pl-0.5"
            ><i
              class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
            /></span
